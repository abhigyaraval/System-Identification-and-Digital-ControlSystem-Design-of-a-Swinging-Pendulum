###########################################################################
## Makefile generated for Simulink model 'Experiment_4_1_PRBS'. 
## 
## Makefile     : Experiment_4_1_PRBS.mk
## Generated on : Sat Apr 25 15:20:10 2020
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Experiment_4_1_PRBS.elf
...
PRODUCT_NAME              = Experiment_4_1_PRBS
MAKEFILE                  = Experiment_4_1_PRBS.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/abhig/OneDrive/Desktop/EEE481/Lab_4/Lab_4_Materials/Lab_4_Materials
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = Experiment_4_1_PRBS_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Experiment_4_1_PRBS.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Experiment_4_1_PRBS_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/system/libsam -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/system/CMSIS/CMSIS/Include -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/system/CMSIS/Device/ATMEL -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/cores/arduino -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/cores/arduino/avr -I$(ARDUINO_SAM_ROOT)/hardware/sam/1.6.11/variants/arduino_due_x -IC:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/arduinotarget/include -IC:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/arduinotarget/scheduler/include -IC:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/arduinobase/include -IC:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/shared/externalmode_daemon/include
...
DEFINES_STANDARD = -DMODEL=Experiment_4_1_PRBS -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : C:/EEE481LabSetup/Experiment4/EEE481Library/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : C:/EEE481LabSetup/Experiment4/EEE481Library/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : C:/EEE481LabSetup/Experiment4/EEE481Library/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : C:/EEE481LabSetup/Experiment4/EEE481Library/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : C:/EEE481LabSetup/Experiment4/EEE481Library/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : C:/Users/abhig/OneDrive/Desktop/EEE481/Lab_4/backup/Lab_4_Materials/EEE481Library/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : C:/Users/abhig/OneDrive/Desktop/EEE481/Lab_4/backup/Lab_4_Materials/EEE481Library/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : C:/Users/abhig/OneDrive/Desktop/EEE481/Lab_4/backup/Lab_4_Materials/EEE481Library/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : C:/Users/abhig/OneDrive/Desktop/EEE481/Lab_4/backup/Lab_4_Materials/EEE481Library/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : C:/Users/abhig/OneDrive/Desktop/EEE481/Lab_4/backup/Lab_4_Materials/EEE481Library/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/Experiment_4_1_PRBS_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/Experiment_4_1_PRBS_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/Experiment_4_1_PRBS_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/Experiment_4_1_PRBS_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/Experiment_4_1_PRBS_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
...
arduinoARMScheduler.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoARMScheduler.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


arm_cortex_m_multitasking.o : C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arm_cortex_m_multitasking.c
	$(CC) $(CFLAGS) -o $@ $<
