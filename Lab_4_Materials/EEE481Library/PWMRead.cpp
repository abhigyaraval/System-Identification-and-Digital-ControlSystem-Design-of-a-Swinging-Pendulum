...
#define S_FUNCTION_NAME PWMRead
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      PWMValue
...
{
    int16_T        *PWMValue  = (int16_T *)ssGetOutputPortRealSignal(S,0);
    const real_T   *xD = ssGetDiscStates(S);

    PWMRead_Outputs_wrapper(PWMValue, xD);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    PWMRead_Update_wrapper(PWMValue,  xD);
}
