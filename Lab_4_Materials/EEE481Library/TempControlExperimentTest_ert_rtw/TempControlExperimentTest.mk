###########################################################################
## Makefile generated for Simulink model 'TempControlExperimentTest'. 
## 
## Makefile     : TempControlExperimentTest.mk
## Generated on : Thu Jan 05 12:55:01 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/TempControlExperimentTest.elf
...
PRODUCT_NAME              = TempControlExperimentTest
MAKEFILE                  = TempControlExperimentTest.mk
COMPUTER                  = PCWIN64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = TempControlExperimentTest_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TempControlExperimentTest.elf
...
DEFINES_STANDARD = -DMODEL=TempControlExperimentTest -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO
...
%.o : $(START_DIR)/TempControlExperimentTest_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/TempControlExperimentTest_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"
...
%.o : $(START_DIR)/TempControlExperimentTest_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/TempControlExperimentTest_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/TempControlExperimentTest_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
