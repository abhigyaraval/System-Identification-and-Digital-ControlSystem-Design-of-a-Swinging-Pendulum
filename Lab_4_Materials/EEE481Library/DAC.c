 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Tue Nov 11 11:44:04 2014
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME DAC
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void DAC_Outputs_wrapper(const int16_T *input,
			const real_T *xD,
			const int8_T  *DACNumber, const int_T  p_width0);
extern void DAC_Update_wrapper(const int16_T *input,
			real_T *xD,
			const int8_T  *DACNumber,  const int_T  p_width0);
...
{
    const int16_T   *input  = (const int16_T*) ssGetInputPortSignal(S,0);
    const real_T   *xD = ssGetDiscStates(S);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int8_T  *DACNumber  = (const int8_T *)mxGetData(PARAM_DEF0(S));


    DAC_Outputs_wrapper(input, xD, DACNumber, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    DAC_Update_wrapper(input,  xD, DACNumber, p_width0);
}
