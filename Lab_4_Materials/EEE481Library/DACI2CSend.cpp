 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Thu Dec 29 14:49:32 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME DACI2CSend
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          1
/* Input Port  0 */
#define IN_PORT_0_NAME      DACValue
...
#define NPARAMS              1
/* Parameter  1 */
#define PARAMETER_0_NAME      SlaveAddress
...
#define SOURCEFILES "__SFB__INC_PATH C:\MATLAB\SupportPackages\R2016a\arduino-1.6.1\hardware\arduino\sam\libraries\Wire"
#define PANELINDEX           6
...
{
    const int16_T   *DACValue  = (const int16_T*) ssGetInputPortSignal(S,0);
    const real_T   *xD = ssGetDiscStates(S);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int8_T  *SlaveAddress  = (const int8_T *)mxGetData(PARAM_DEF0(S));

    DACI2CSend_Outputs_wrapper(DACValue, xD, SlaveAddress, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    DACI2CSend_Update_wrapper(DACValue,  xD, SlaveAddress, p_width0);
}
