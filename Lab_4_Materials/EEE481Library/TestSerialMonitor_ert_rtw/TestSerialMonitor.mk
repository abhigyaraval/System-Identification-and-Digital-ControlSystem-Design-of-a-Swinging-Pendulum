###########################################################################
## Makefile generated for Simulink model 'TestSerialMonitor'. 
## 
## Makefile     : TestSerialMonitor.mk
## Generated on : Mon Dec 26 13:03:35 2016
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/TestSerialMonitor.elf
...
PRODUCT_NAME              = TestSerialMonitor
MAKEFILE                  = TestSerialMonitor.mk
COMPUTER                  = PCWIN64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = TestSerialMonitor_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TestSerialMonitor.elf
...
DEFINES_STANDARD = -DMODEL=TestSerialMonitor -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
%.o : $(START_DIR)/TestSerialMonitor_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/TestSerialMonitor_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"
...
%.o : $(START_DIR)/TestSerialMonitor_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/TestSerialMonitor_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/TestSerialMonitor_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
