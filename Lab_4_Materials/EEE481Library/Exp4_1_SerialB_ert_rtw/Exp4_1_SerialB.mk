###########################################################################
## Makefile generated for Simulink model 'Exp4_1_SerialB'. 
## 
## Makefile     : Exp4_1_SerialB.mk
## Generated on : Sat Oct 21 12:42:30 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Exp4_1_SerialB.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Exp4_1_SerialB_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Exp4_1_SerialB.elf
...
DEFINES_ = -DMODEL=Exp4_1_SerialB -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -DMW_TIMERID=9 -DMW_TIMERCOUNT=656250 -DMW_SAM_CLOCKID=TC_CMR_TCCLKS_TIMER_CLOCK4 -D_RTT_BAUDRATE_SERIAL0_=19200 -D_RTT_BAUDRATE_SERIAL1_=19200 -D_RTT_BAUDRATE_SERIAL2_=19200 -D_RTT_BAUDRATE_SERIAL3_=19200 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=Exp4_1_SerialB -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
%.o : $(START_DIR)/Exp4_1_SerialB_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Exp4_1_SerialB_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"
...
%.o : $(START_DIR)/Exp4_1_SerialB_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Exp4_1_SerialB_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Exp4_1_SerialB_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
