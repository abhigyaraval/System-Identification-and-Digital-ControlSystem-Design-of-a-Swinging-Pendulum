 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Wed Nov 16 10:48:25 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME pHRead
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          2
/* Input Port  0 */
#define IN_PORT_0_NAME      CommandNumber
...
/* Input Port  1 */
#define IN_PORT_1_NAME      TriggerCommand
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      pHValue
...
#define NPARAMS              1
/* Parameter  1 */
#define PARAMETER_0_NAME      SerialPortNumber
...
{
    const int8_T   *CommandNumber  = (const int8_T*) ssGetInputPortSignal(S,0);
    const int8_T   *TriggerCommand  = (const int8_T*) ssGetInputPortSignal(S,1);
    real_T        *pHValue  = (real_T *)ssGetOutputPortRealSignal(S,0);
    const real_T   *xD = ssGetDiscStates(S);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int8_T  *SerialPortNumber  = (const int8_T *)mxGetData(PARAM_DEF0(S));

    pHRead_Outputs_wrapper(CommandNumber, TriggerCommand, pHValue, xD, SerialPortNumber, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    pHRead_Update_wrapper(CommandNumber, TriggerCommand, pHValue,  xD, SerialPortNumber, p_width0);
}
