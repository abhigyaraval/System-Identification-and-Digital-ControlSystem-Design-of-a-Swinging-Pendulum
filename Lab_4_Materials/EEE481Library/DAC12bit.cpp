 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Fri Oct 20 18:04:20 2017
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME DAC12bit
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          1
/* Input Port  0 */
#define IN_PORT_0_NAME      DACInput
...
#define NPARAMS              1
/* Parameter  1 */
#define PARAMETER_0_NAME      DACNumber
...
#define SOURCEFILES "__SFB__# ifndef MATLAB_MEX_FILE__SFB__# include <Arduino.h>__SFB____SFB__# endif"
#define PANELINDEX           6
...
{
    const int16_T   *DACInput  = (const int16_T*) ssGetInputPortSignal(S,0);
    const real_T   *xD = ssGetDiscStates(S);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int8_T  *DACNumber  = (const int8_T *)mxGetData(PARAM_DEF0(S));

    DAC12bit_Outputs_wrapper(DACInput, xD, DACNumber, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    DAC12bit_Update_wrapper(DACInput,  xD, DACNumber, p_width0);
}
