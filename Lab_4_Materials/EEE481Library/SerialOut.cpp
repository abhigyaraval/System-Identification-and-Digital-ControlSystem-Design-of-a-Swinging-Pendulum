 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sat Nov 26 14:46:17 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SerialOut
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SerialOut_Outputs_wrapper(input, xD, SerialNumber, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    SerialOut_Update_wrapper(input,  xD, SerialNumber, p_width0);
}
