###########################################################################
## Makefile generated for Simulink model 'pHSystemRead'. 
## 
## Makefile     : pHSystemRead.mk
## Generated on : Sun Dec 18 14:39:10 2016
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pHSystemRead.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = pHSystemRead_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pHSystemRead.elf
...
DEFINES_STANDARD = -DMODEL=pHSystemRead -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
%.o : $(START_DIR)/pHSystemRead_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/pHSystemRead_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"
...
%.o : $(START_DIR)/pHSystemRead_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/pHSystemRead_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/pHSystemRead_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
