 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Mon Jun 29 20:28:05 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Pwm12BOut
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define NPARAMS              1
/* Parameter  1 */
#define PARAMETER_0_NAME      PwmPin
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const uint32_T  *PwmPin  = (const uint32_T *)mxGetData(PARAM_DEF0(S));


    Pwm12BOut_Outputs_wrapper(input, xD, PwmPin, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    Pwm12BOut_Update_wrapper(input,  xD, PwmPin, p_width0);
}
