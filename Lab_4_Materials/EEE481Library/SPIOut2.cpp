 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Thu Dec 22 13:19:23 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SPIOut2
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    SPIOut2_Outputs_wrapper(input1, input2, xD, ADCNumber, p_width0, CS, p_width1);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    SPIOut2_Update_wrapper(input1, input2,  xD, ADCNumber, p_width0, CS, p_width1);
}
