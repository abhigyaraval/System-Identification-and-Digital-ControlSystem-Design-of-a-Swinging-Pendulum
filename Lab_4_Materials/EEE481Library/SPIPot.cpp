 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Fri Dec 30 10:34:58 2016
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME SPIPot
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          2
/* Input Port  0 */
#define IN_PORT_0_NAME      PotLevel
...
/* Input Port  1 */
#define IN_PORT_1_NAME      PotAddress
...
{
    const uint8_T   *PotLevel  = (const uint8_T*) ssGetInputPortSignal(S,0);
    const uint8_T   *PotAddress  = (const uint8_T*) ssGetInputPortSignal(S,1);
    const real_T   *xD = ssGetDiscStates(S);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int8_T  *CS  = (const int8_T *)mxGetData(PARAM_DEF0(S));

    SPIPot_Outputs_wrapper(PotLevel, PotAddress, xD, CS, p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    SPIPot_Update_wrapper(PotLevel, PotAddress,  xD, CS, p_width0);
}
