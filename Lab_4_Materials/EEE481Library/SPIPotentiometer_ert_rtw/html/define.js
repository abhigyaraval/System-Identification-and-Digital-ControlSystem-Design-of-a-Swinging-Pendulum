...
this.def["SPIPotentiometer_B"] = {file: "SPIPotentiometer_c.html",line:24,type:"var"};
this.def["SPIPotentiometer_DW"] = {file: "SPIPotentiometer_c.html",line:27,type:"var"};
this.def["SPIPotentiometer_M_"] = {file: "SPIPotentiometer_c.html",line:30,type:"var"};
this.def["SPIPotentiometer_M"] = {file: "SPIPotentiometer_c.html",line:31,type:"var"};
this.def["SPIPotentiometer_step"] = {file: "SPIPotentiometer_c.html",line:34,type:"fcn"};
this.def["SPIPotentiometer_initialize"] = {file: "SPIPotentiometer_c.html",line:218,type:"fcn"};
this.def["SPIPotentiometer_terminate"] = {file: "SPIPotentiometer_c.html",line:305,type:"fcn"};
this.def["B_SPIPotentiometer_T"] = {file: "SPIPotentiometer_h.html",line:57,type:"type"};
this.def["DW_SPIPotentiometer_T"] = {file: "SPIPotentiometer_h.html",line:65,type:"type"};
this.def["P_SPIPotentiometer_T"] = {file: "SPIPotentiometer_types_h.html",line:25,type:"type"};
this.def["RT_MODEL_SPIPotentiometer_T"] = {file: "SPIPotentiometer_types_h.html",line:28,type:"type"};
this.def["SPIPotentiometer_P"] = {file: "SPIPotentiometer_data_c.html",line:24,type:"var"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["SPIPotentiometer_c.html"] = "../SPIPotentiometer.c";
	this.html2Root["SPIPotentiometer_c.html"] = "SPIPotentiometer_c.html";
	this.html2SrcPath["SPIPotentiometer_h.html"] = "../SPIPotentiometer.h";
	this.html2Root["SPIPotentiometer_h.html"] = "SPIPotentiometer_h.html";
	this.html2SrcPath["SPIPotentiometer_private_h.html"] = "../SPIPotentiometer_private.h";
	this.html2Root["SPIPotentiometer_private_h.html"] = "SPIPotentiometer_private_h.html";
	this.html2SrcPath["SPIPotentiometer_types_h.html"] = "../SPIPotentiometer_types.h";
	this.html2Root["SPIPotentiometer_types_h.html"] = "SPIPotentiometer_types_h.html";
	this.html2SrcPath["SPIPotentiometer_data_c.html"] = "../SPIPotentiometer_data.c";
	this.html2Root["SPIPotentiometer_data_c.html"] = "SPIPotentiometer_data_c.html";
