###########################################################################
## Makefile generated for Simulink model 'SPIPotentiometer'. 
## 
## Makefile     : SPIPotentiometer.mk
## Generated on : Fri Dec 30 13:45:08 2016
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SPIPotentiometer.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = SPIPotentiometer_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SPIPotentiometer.elf
...
DEFINES_STANDARD = -DMODEL=SPIPotentiometer -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
%.o : $(START_DIR)/SPIPotentiometer_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/SPIPotentiometer_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"
...
%.o : $(START_DIR)/SPIPotentiometer_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/SPIPotentiometer_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/SPIPotentiometer_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
