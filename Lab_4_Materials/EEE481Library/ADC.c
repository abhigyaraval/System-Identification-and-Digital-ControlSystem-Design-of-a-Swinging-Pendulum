 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Wed Apr 15 13:53:10 2015
*/
...
extern void ADC_Outputs_wrapper(int16_T *output,
			const real_T *xD,
			const int8_T  *ADCNumber, const int_T  p_width0);
extern void ADC_Update_wrapper(const int16_T *output,
			real_T *xD,
			const int8_T  *ADCNumber,  const int_T  p_width0);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    ADC_Update_wrapper(output,  xD, ADCNumber, p_width0);
}
